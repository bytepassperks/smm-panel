...
<head>
    ...
    <title>Best SMM Panel in Pakistan | Buy Followers, Likes & Views</title>
    <meta name="description" content="Top SMM panel in Pakistan. Buy Instagram followers, likes, TikTok views. Instant delivery, 30-day refill.">
    <meta name="geo.region" content="PK">
    <link rel="canonical" href="<?= $siteUrl ?>/pakistan">
    ...
    <style>
        ...
        .city-hero { background: linear-gradient(135deg, #01411c 0%, #1a5c2e 100%); padding: 5rem 0; text-align: center; color: white; }
        ...
        .city-cta { background: linear-gradient(135deg, #01411c 0%, #1a5c2e 100%); padding: 4rem 0; text-align: center; color: white; }
        .city-cta .btn { background: white; color: #01411c; padding: 14px 32px; font-size: 1.1rem; font-weight: 600; text-decoration: none; border-radius: 10px; }
    </style>
</head>
<body>
